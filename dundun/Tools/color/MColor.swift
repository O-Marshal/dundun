...
class MColor {
     ...
     /// 系统主题颜色
    static let themeColor = UIColor(red: 0.4, green: 0.6, blue: 1, alpha: 1)
    
     /// 文本标题颜色
    static let textHeaderColor = UIColor(red: 0.2, green: 0.2, blue: 0.2, alpha: 1)
    
    static let textLabelColor = UIColor(red: 0.4, green: 0.4, blue: 0.4, alpha: 1)
